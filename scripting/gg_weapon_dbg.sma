...
#define PLUGIN "[GG] Dual Beretta"
#define VERSION "3.0"
#define AUTHOR "Asdian"

// Data Config
#define P_GUNKATA_M "models/[GeekGamers]/Secondary/p_gunkata.mdl"
#define P_GUNKATA_W "models/[GeekGamers]/Secondary/p_gunkata2.mdl"
#define V_GUNKATA "models/[GeekGamers]/Secondary/v_gunkata.mdl"
#define W_GUNKATA "models/[GeekGamers]/Secondary/w_gunkata.mdl"

#define MODEL_BLAST "models/[GeekGamers]/Secondary/ef_scorpion_hole.mdl"
#define MODEL_SHADOW "models/[GeekGamers]/Secondary/ef_gunkata_man.mdl"
...
#define WEAPON_SPRITE "sprites/[GeekGamers]/Weapons/640hud176.spr"
...
#define KNOCKBACK_SPECIAL 700.0
#define DAMAGE_SPECIAL 75.0
...
public plugin_init()
{
	...
	// Cache
	//register_clcmd("dbg", "Get_Base")
	cvar_shadow = register_cvar("dbg_show_shadow", "0")
	
	register_clcmd("gg_weapon_gunkata", "hook_weapon")
}
...
public plugin_precache()
{
	...
	precache_model(WEAPON_SPRITE)
	
	precache_generic("sprites/gg_weapon_gunkata.txt")
...
{
	register_native("gg_set_user_dualberetta", "native_give_dberetta", 1)
}

public native_give_dberetta(id)
{
	Get_Base(id)
}
...
public message_DeathMsg(msg_id, msg_dest, msg_ent)
{
	...
	set_msg_arg_string(4, "Dual Beretta Gunslinger")
	return PLUGIN_CONTINUE
}
...
public fw_Item_AddToPlayer_Post(Ent, id)
{
	...
	write_string(Get_BitVar(g_Had_Base, id) ? "gg_weapon_gunkata" : weapon_gunkata)
	write_byte(8)
	write_byte(35)
	write_byte(-1)
	write_byte(-1)
