...
#define BONUSDAMAGE 5
#define CLIP 40
#define BPAMMO 90

#define SCYTHE_SLASHTIME 3.0

#define STAGE_AMMO 13 // every x ammo -> stage up
#define RELOAD_TIME 3.25
#define ANIME_EXT "onehanded"

#define V_MODEL "models/[GeekGamers]/Primary/v_thanatos3.mdl"
#define P_MODEL "models/[GeekGamers]/Primary/p_thanatos3.mdl"
#define W_MODEL "models/[GeekGamers]/Primary/w_thanatos3.mdl"
#define W_MODEL2 "models/[GeekGamers]/Primary/w_thanatos3b.mdl"
#define S_MODEL "models/[GeekGamers]/Primary/thanatos3_knife.mdl"
#define S_MODEL2 "models/[GeekGamers]/Primary/thanatos3_wind.mdl"
...
{
	register_native("gg_set_user_thanatos3", "Get_Thanatos3", 1);
}
...
public fw_Scythe_Think(Ent)
{
	...
	if(is_user_alive(Target))
	{
		...
		ExecuteHamB(Ham_TakeDamage, Target, 0, Owner, 1.0, DMG_SLASH)
	} else {
		if(Target)
		{
			set_pev(Ent, pev_flags, FL_KILLME)
...
public fw_Scythe_Touch(Ent, id)
{
	...
	if(!is_user_alive(id))
	{
		...
		// Bullet Hole
		static Owner; Owner = pev(Ent, pev_owner)
		Make_BulletHole(Owner, Origin, float(BONUSDAMAGE))
