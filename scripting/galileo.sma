...
public plugin_init()
{
	...
	register_concmd("startvote", "cmd_startVote", ADMIN_MAP);
	register_concmd("say /start", "cmd_startVote", ADMIN_MAP);
...
public cmd_say(id)
{
	...
	if (arg3[0] == 0)
	{
		...
		{
			if ((get_pcvar_num(cvar_rtvCommands) & RTV_CMD_SHORTHAND && (equali(arg1, "rtv") || equali(arg1, "rockthevote"))) || ((get_pcvar_num(cvar_rtvCommands) & RTV_CMD_DYNAMIC && equali(arg1, "rockthe", 7) && equali(arg1[strlen(arg1)-4], "vote"))))
			{
				vote_rock(id);
				return PLUGIN_HANDLED;
			}
