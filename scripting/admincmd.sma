...
public plugin_init()
{
	...
	register_concmd("amx_banggp", "cmdBan", ADMIN_BAN|ADMIN_BAN_TEMP, "<name or #userid> <minutes> [reason]")
	register_concmd("amx_banipggp", "cmdBanIP", ADMIN_BAN|ADMIN_BAN_TEMP, "<name or #userid> <minutes> [reason]")
	register_concmd("amx_addbanggp", "cmdAddBan", ADMIN_BAN, "<^"authid^" or ip> <minutes> [reason]")
	register_concmd("amx_unban", "cmdUnban", ADMIN_BAN|ADMIN_BAN_TEMP, "<^"authid^" or ip>")
	register_concmd("amx_slay", "cmdSlay", ADMIN_SLAY, "<name or #userid>")
	register_concmd("amx_slap", "cmdSlap", ADMIN_SLAY, "<name or #userid> [power]")
	register_concmd("ggsv_amx_leave", "cmdLeave", ADMIN_KICK, "<tag> [tag] [tag] [tag]")
	register_concmd("ggsv_amx_pause", "cmdPause", ADMIN_CVAR, "- pause or unpause the game")
	register_concmd("amx_who", "cmdWho", ADMIN_ADMIN, "- displays who is on server")
	register_concmd("ggsv_amx_cvar", "cmdCvar", ADMIN_CVAR, "<cvar> [value]")
	register_concmd("ggsv_amx_xvar_float", "cmdXvar", ADMIN_CVAR, "<xvar> [value]")
	register_concmd("ggsv_amx_xvar_int", "cmdXvar", ADMIN_CVAR, "<xvar> [value]")
	register_concmd("ggsv_amx_plugins", "cmdPlugins", ADMIN_ADMIN)
	register_concmd("ggsv_amx_modules", "cmdModules", ADMIN_ADMIN)
	...
	register_concmd("ggsv_amx_cfg", "cmdCfg", ADMIN_CFG, "<filename>")
	register_concmd("ggsv_amx_nick", "cmdNick", ADMIN_SLAY, "<name or #userid> <new nick>")
	register_concmd("ggsv_amx_last", "cmdLast", ADMIN_BAN, "- list the last few disconnected clients info");
	//register_clcmd("ggsv_amx_rcon", "cmdRcon", ADMIN_RCON, "<command line>")
	//register_clcmd("ggsv_amx_showrcon", "cmdShowRcon", ADMIN_RCON, "<command line>")
...
public cmdXvar(id, level, cid)
{
	...
	new bFloat = equali(cmd, "ggsv_amx_xvar_float");
...
public cmdPlugins(id, level, cid)
{
	...
	else
	{
		...
		replace_all(Temp,charsmax(Temp),"amx_help","ggsv_amx_plugins");
		console_print(id,"%s",Temp);
	}
