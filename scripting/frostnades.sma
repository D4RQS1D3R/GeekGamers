...
new const MODEL_FROZEN[]	= "models/[GeekGamers]/iceblock.mdl";
...
new const sprite_grenade_sprx[]	= "models/[GeekGamers]/frostexp.spr"
new const sprite_grenade_flar[]	= "models/[GeekGamers]/minifrostexp.spr"

new sprSpr, sprFlr ,g_trailSpr ,entity
...
new isChilled[33], isFrozen[33], frostKilled[33], novaDisplay[33], Float:glowColor[33][3], Float:oldGravity[33], Float:oldSpeed[33], oldRenderFx[33],
		Float:oldRenderColor[33][3], oldRenderMode[33], Float:oldRenderAmt[33], hasFrostNade[33], nadesBought[33];

public plugin_init()
{
	register_plugin("[GG] Frost Nade", VERSION, "~D4rkSiD3Rs~");
...
{
	register_native("is_user_frozen", "native_frozen", 1);
}
