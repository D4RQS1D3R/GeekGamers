...
{
	register_clcmd("ggsv_amx_statscfgmenu", "cmdCfgMenu", ADMIN_CFG, "- displays stats configuration menu")
	register_dictionary("statscfg.txt")
	register_dictionary("common.txt")
	register_concmd("ggsv_amx_statscfg", "cmdCfg", ADMIN_CFG, "- displays help for stats configuration")
}
