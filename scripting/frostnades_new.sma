...
#define ice_model "models/[GeekGamers]/iceblock.mdl"
//#define V_MODEL "models/[GeekGamers]/v_frostnade_GG.mdl"

new have_frost[33], iceent[33], g_glassSpr, g_msgScreenFade, grenadetrail, frostgib, g_explosfr, g_exploSpr, g_msgDamage
public plugin_init()
{
	register_plugin("[GG] Avalanche Frost" , "1.0" , "D4rkSiD3Rs")
	...
	//register_clcmd("say /frost", "give_avalfrost")
	//register_clcmd("say /get", "give_avalfrost")
}

public plugin_precache()
{
	grenadetrail = engfunc(EngFunc_PrecacheModel, "sprites/laserbeam.spr")
	g_explosfr = precache_model("models/[GeekGamers]/frostexp.spr")
	g_exploSpr = engfunc(EngFunc_PrecacheModel, "sprites/shockwave.spr")
	frostgib = precache_model("models/[GeekGamers]/minifrostexp.spr")
	...
	engfunc(EngFunc_PrecacheSound, "[GeekGamers]/Frost/frostnova.wav")
	engfunc(EngFunc_PrecacheSound, "[GeekGamers]/Frost/impalehit.wav")
	engfunc(EngFunc_PrecacheSound, "[GeekGamers]/Frost/impalelaunch1.wav")
}
...
frost_explode(ent)
{
	...
	emit_sound(ent, CHAN_WEAPON, "frost/frostnova.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
	...
	for(new i = 0; i < get_maxplayers(); i++)
	{
		...
		emit_sound(i, CHAN_BODY, "frost/impalehit.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
...
public remove_freeze(id)
{
	...
	// Broken glass sound
	emit_sound(id, CHAN_BODY, "frost/impalelaunch1.wav", 1.0, ATTN_NORM, 0, PITCH_NORM)
