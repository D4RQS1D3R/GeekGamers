...
new g_coloredMenus
new g_Modified
new g_addCmd[] = "ggsv_amx_pausecfg add ^"%s^""
...
public plugin_init()
{
	...
	register_concmd("ggsv_amx_pausecfg", "cmdPlugin", ADMIN_CFG, "- list commands for pause/unpause management")
	register_clcmd("ggsv_amx_pausecfgmenu", "cmdMenu", ADMIN_CFG, "- pause/unpause plugins with menu")
#if defined DIRECT_ONOFF
	register_concmd("ggsv_amx_off", "cmdOFF", ADMIN_CFG, "- pauses some plugins")
	register_concmd("ggsv_amx_on", "cmdON", ADMIN_CFG, "- unpauses some plugins")
#endif
