...
// Level 1 Config
/*
#define V_MODEL "models/[GeekGamers]/Primary/v_plasmagun_xmas.mdl"
#define P_MODEL "models/[GeekGamers]/Primary/p_plasmagun_xmas.mdl"
*/
#define V_MODEL "models/[GeekGamers]/Primary/v_plasmagun2.mdl"
#define P_MODEL "models/[GeekGamers]/Primary/p_plasmagun.mdl"
#define W_MODEL "models/[GeekGamers]/Primary/w_plasmagun.mdl"
...
{
	"sprites/[GeekGamers]/Weapons/plasmaball.spr",
	"sprites/[GeekGamers]/Weapons/plasmabomb.spr"
}
...
public plugin_init() 
{
	...
	//register_clcmd("admin_get_plasmagun", "Get_Plasma", ADMIN_LEVEL_B)
...
{
	register_native("gg_set_user_plasmagun", "native_give_weapon_add", 1)
}
...
public Damage_Plasma(Ent, Id)
{
	...
	if(is_user_alive(Id) && cs_get_user_team(Id) != Get_PlasmaTeam(Ent))
		ExecuteHamB(Ham_TakeDamage, Id, 0, Attacker, float(DAMAGE), DMG_GENERIC)
	...
	for(new i = 0; i < g_MaxPlayers; i++)
	{
		...
		ExecuteHamB(Ham_TakeDamage, i, 0, Attacker, float(DAMAGE) / random_float(1.25, 1.5), DMG_GENERIC)
	}
}
