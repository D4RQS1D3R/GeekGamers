...
new const grenade_fire_player[][] = { "scientist/sci_pain1.wav", "scientist/scream02.wav", "scientist/scream07.wav" }
...
new const sprite_grenade_sprx[]	= "models/[GeekGamers]/fireexp.spr"
new const sprite_grenade_flar[]	= "models/[GeekGamers]/minifireexp.spr"
...
new g_flameSpr, g_smokeSpr, g_trailSpr, g_exploSpr, sprSpr, sprFlr
...
{
	sprSpr = precache_model(sprite_grenade_sprx)
	sprFlr = precache_model(sprite_grenade_flar)
...
public plugin_init()
{
	...
	register_plugin("[GG] Napalm Nade", "2.8", "~D4rkSiD3Rs~")
	...
	// Client commands
	//register_clcmd("He_Flame", "buy_napalm")
	...
	cvar_price = register_cvar("napalm_dprice", "0")
	cvar_buyzone = register_cvar("napalm_dbuyzone", "0")
	cvar_carrylimit = register_cvar("napalm_carrylimit", "1")
	
	cvar_radius = register_cvar("napaldm_radius", "240")
	cvar_hitself = register_cvar("napaldm_hitself", "0")
	cvar_ff = register_cvar("napdalm_ff", "0")
	cvar_spread = register_cvar("napalmd_spread", "1")
	cvar_keepexplosion = register_cvar("napalm_keepexplosion", "0")
	
	cvar_duration = register_cvar("napalm_duration", "3")
	cvar_damage = register_cvar("napalm_damage", "2")
	cvar_cankill = register_cvar("napalm_candkill", "0")
...
#if defined USE_NAPALM_CUSTOM_MODELS
	// Set custom model and supercede the zal forward
...
napalm_explode(ent)
{
	...
	while ((victim = engfunc(EngFunc_FindEntityInSphere, victim, origin, g_radius)) != 0)
	{
