...
new const HaveShadowAxeModel[66] = "models/[Geek~Gamers]/Knives/v_shadow_axe.mdl";
...
public ShowMenuKnife(id)
{
	...
	if(get_user_flags(id) & VIP_FLAG)
		...
		menu_additem(menu, "\dUltimate Knife \r(Only Silver V.I.P) [Level: 15]", "2");
...
public DamageArme (iVictim, iInflictor, iAttacker, Float:fDamage, iDamageBits)
{
   ...
   if(iInflictor == iAttacker && is_user_alive(iAttacker) && cs_get_user_team(iAttacker) == CS_TEAM_SPECTATOR)
   {
